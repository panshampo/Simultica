...
description: Install the Si-Multica CLI and start the agent daemon.
---
...
This configures the CLI for Si-Multica Cloud, opens your browser for login, discovers your workspaces, and starts the agent daemon.

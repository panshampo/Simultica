---
title: Architecture
description: Technical architecture of the Si-Multica platform.
---

## Overview

Si-Multica is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.

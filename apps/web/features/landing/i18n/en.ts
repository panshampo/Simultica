    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multica scans for 14 supported coding tools \u2014 Antigravity, Claude Code, DS Copilot, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, and Traex \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 14 supported coding tools (Antigravity, Claude Code, DS Copilot, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Traex). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "Multica supports 14 coding tools out of the box: Antigravity, Claude Code, DS Copilot, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, and Traex. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {

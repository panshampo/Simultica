      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Multica는 Antigravity, Claude Code, DS Copilot, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Traex 등 14개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          answer:
            "Multica는 Antigravity, Claude Code, DS Copilot, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Traex 등 14개 코딩 도구를 기본 지원합니다. 데몬이 이미 설치된 CLI를 자동으로 찾아 각각 런타임으로 등록합니다. 오픈소스이므로 직접 백엔드를 추가할 수도 있습니다.",
        },
        {

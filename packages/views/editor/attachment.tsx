...
function normalize(
  ...
  if (input.kind === "record") {
    const mediaUrl = input.attachment.download_url || input.attachment.url;
    return {
      filename: input.attachment.filename,
      contentType: input.attachment.content_type,
      url: resolvePublicFileUrl(mediaUrl) ?? mediaUrl,
  ...
  const mediaUrl = record?.download_url || input.url;
  return {

...
describe("Attachment — image dispatch", () => {
  ...
  it("record image resolves server-relative download_url against API base", () => {
    const att = makeRecord({
    ...
    const img = document.querySelector("img");
    expect(img?.getAttribute("src")).toBe("http://127.0.0.1:8080/api/attachments/att-1/download");
  });

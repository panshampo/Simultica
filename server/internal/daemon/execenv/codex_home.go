...
type CodexHomeOptions struct {
	...
	GOOS string
	// WritableRoots are extra external directories that should be writable
	// when the sandbox mode supports workspace-write. They come from
	// external_directory project resources and do not affect global reads.

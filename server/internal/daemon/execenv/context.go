...
func skillsDirPath(workDir, provider string) string {
	...
	case "traex":
		// Traex inherits the Codex skills layout; the CLI auto-discovers
		// workspace-level skills from .trae/skills/ next to the project's
		// AGENTS.md.
		return filepath.Join(workDir, ".trae", "skills")
	default:

...
func (h *Handler) CreateIssue(w http.ResponseWriter, r *http.Request) {
	...
	if req.OriginType != nil || req.OriginID != nil {
		...
		case "quick_create", "workflow_node":
			// Allowed — daemon CLI passes quick_create, and the workflow sidecar
			// stamps sub-issues with workflow_node so child-done does not wake
			// the parent agent outside the runtime workflow.
		default:

...
func (f *enricherFakeClient) SendMessageReaction(context.Context, SendReactionParams) (string, error) {
	return "", nil
}
...
func (f *enricherFakeClient) UploadImage(context.Context, InstallationCredentials, UploadImageParams) (string, error) {
	return "", nil
}

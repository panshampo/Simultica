...
type IssueCreateOpts struct {
	...
	// SkipEnqueueOnAssign creates the Issue without triggering the normal
	// assignee task. Used by transports that enqueue their own canonical
	// follow-up task after attaching additional context.
	SkipEnqueueOnAssign bool
}

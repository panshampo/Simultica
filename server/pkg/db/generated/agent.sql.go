...
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, lark_issue_project_id
`
...
RETURNING id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, automation_run_id
`
...
type CreateAgentParams struct {
	...
	LarkIssueProjectID pgtype.UUID `json:"lark_issue_project_id"`
}
...
const createWorkflowMainNodeTask = `-- name: CreateWorkflowMainNodeTask :one
INSERT INTO agent_task_queue (agent_id, runtime_id, issue_id, status, priority, context)
VALUES ($1, $2, $3, 'queued', $4, $5)
RETURNING id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, automation_run_id
`

type CreateWorkflowMainNodeTaskParams struct {
	AgentID   pgtype.UUID `json:"agent_id"`
	RuntimeID pgtype.UUID `json:"runtime_id"`
	IssueID   pgtype.UUID `json:"issue_id"`
	Priority  int32       `json:"priority"`
...
func (q *Queries) CreateWorkflowMainNodeTask(ctx context.Context, arg CreateWorkflowMainNodeTaskParams) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, createWorkflowMainNodeTask,
		arg.AgentID,
		arg.RuntimeID,
		arg.IssueID,
		arg.Priority,
...
const createWorkflowPlannerTask = `-- name: CreateWorkflowPlannerTask :one
INSERT INTO agent_task_queue (agent_id, runtime_id, issue_id, status, priority, context)
VALUES ($1, $2, $3, 'queued', $4, $5)
RETURNING id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, automation_run_id
`

type CreateWorkflowPlannerTaskParams struct {
	AgentID   pgtype.UUID `json:"agent_id"`
	RuntimeID pgtype.UUID `json:"runtime_id"`
	IssueID   pgtype.UUID `json:"issue_id"`
	Priority  int32       `json:"priority"`
...
// normal issue reply.
func (q *Queries) CreateWorkflowPlannerTask(ctx context.Context, arg CreateWorkflowPlannerTaskParams) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, createWorkflowPlannerTask,
		arg.AgentID,
		arg.RuntimeID,
		arg.IssueID,
		arg.Priority,
...
RETURNING t.id, t.agent_id, t.issue_id, t.status, t.priority, t.dispatched_at, t.started_at, t.completed_at, t.result, t.error, t.created_at, t.context, t.runtime_id, t.session_id, t.work_dir, t.trigger_comment_id, t.chat_session_id, t.autopilot_run_id, t.attempt, t.max_attempts, t.parent_task_id, t.failure_reason, t.trigger_summary, t.force_fresh_session, t.is_leader_task, t.wait_reason, t.automation_run_id
`
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, lark_issue_project_id FROM agent
WHERE id = $1
`
...
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, automation_run_id FROM agent_task_queue
WHERE id = $1
`
...
SELECT atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.trigger_summary, atq.force_fresh_session, atq.is_leader_task, atq.wait_reason, atq.automation_run_id FROM agent_task_queue atq
...
const setAgentLarkIssueProject = `-- name: SetAgentLarkIssueProject :one
UPDATE agent SET lark_issue_project_id = $2, updated_at = now()
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, lark_issue_project_id
`

type SetAgentLarkIssueProjectParams struct {
	ID                 pgtype.UUID `json:"id"`
	LarkIssueProjectID pgtype.UUID `json:"lark_issue_project_id"`
}
...
func (q *Queries) SetAgentLarkIssueProject(ctx context.Context, arg SetAgentLarkIssueProjectParams) (Agent, error) {
	row := q.db.QueryRow(ctx, setAgentLarkIssueProject, arg.ID, arg.LarkIssueProjectID)
	var i Agent
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
...
UPDATE agent SET
    ...
    lark_issue_project_id = COALESCE($17, lark_issue_project_id),
    updated_at = now()
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, lark_issue_project_id
`

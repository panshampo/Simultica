...
) RETURNING id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, origin_type, origin_id, first_executed_at, start_date, metadata, automation_run_id, issue_template_id, issue_template_snapshot
`
...
const createIssueWithTemplate = `-- name: CreateIssueWithTemplate :one
INSERT INTO issue (
    workspace_id, title, description, status, priority,
    assignee_type, assignee_id, creator_type, creator_id,
    parent_issue_id, position, start_date, due_date, number, project_id,
...
type CreateIssueWithTemplateParams struct {
	WorkspaceID           pgtype.UUID `json:"workspace_id"`
	Title                 string      `json:"title"`
	Description           pgtype.Text `json:"description"`
	Status                string      `json:"status"`
...
func (q *Queries) CreateIssueWithTemplate(ctx context.Context, arg CreateIssueWithTemplateParams) (Issue, error) {
	row := q.db.QueryRow(ctx, createIssueWithTemplate,
		arg.WorkspaceID,
		arg.Title,
		arg.Description,
		arg.Status,
